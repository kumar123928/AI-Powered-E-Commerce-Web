...
// formData.append("upload present", uploadPreset)
...
try {
    ...
    // 2️⃣ Send product data + Cloudinary URLs to backend
    const result = await axios.post(
      serverUrl + "/api/product/addProduct",
      {
        ...
        bestSeller,
        sizes,
        images: [imageUrl1, imageUrl2, imageUrl3, imageUrl4], // Correct format
      },
        ...
        <form action="" onSubmit={handleAddProduct} className='w-[100%] md:w-[90%] h-[100%] mt-[70px] flex flex-col gap-[30px] py-[60px] px-[30px] md:px-[60px]'>
          ...
          <div className='w-[80%] h-[130px] flex items-start justify-center flex-col mt-[20px] gap-[10px]'><p className='text-[20px] md:text-[25px] font-semibold'> Upload Images</p>
            <div className='w-[100%] flex items-center justify-start'>
              <label htmlFor="image1" className='w-[65px] h-[65] md:w-[100px] cursor-pointer hover:border-[#46d1f7]'>
              ...
              <label htmlFor="image2" className='w-[65px] h-[65] md:w-[100px] cursor-pointer hover:border-[#46d1f7]'>
              ...
              <label htmlFor="image3" className='w-[65px] h-[65] md:w-[100px] cursor-pointer hover:border-[#46d1f7]'>
              ...
              <label htmlFor="image4" className='w-[65px] h-[65] md:w-[100px] cursor-pointer hover:border-[#46d1f7]'>
          ...
          <div className='w-[80%] h-[100px] flex flex-col gap-[10px]  '>
            ...
            <input type="text" placeholder='Type Here' className='w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]' onChange={(e) => setName(e.target.value)} value={name} />
          </div>

          <div className='w-[80%] flex  flex-col gap-[10px]  '>
            <p className='text-[20px] md:text-[25px] font-semibold'>Product Description</p>
            <textarea type="text" placeholder='Type Here' className='w-[600px] max-w-[98%] h-[100px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] py-[10px] text-[18px]  placeholder:text-[#ffffffc2]' onChange={(e) => setDescription(e.target.value)} value={description} />
          </div>
          <div className='w-[80%] flex items-center gap-[10px] flex-wrap'>
            <div className='md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px]'><p className='text-[20px] md:text-[25px] font-semibold w-[100%]'>Product Category </p>
            ...
            <div className='md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px]'><p className='text-[20px] md:text-[25px] font-semibold w-[100%]'>Sub-Category </p>
          ...
          <div className='w-[80%] h-[220px] md:h-[100px] flex items-start justify-center flex-col gap-[10px] py-[10px] md:py-[0px]'></div>
...
<button className='w-[140px] px-[20px] py-[20px] rounded-xl bg-[#65d8f7] flex items-center gap-[10px] text-[black] active:bg-slate-700 active:text-[white] active:border-[2px] border-[white] cursor-pointer'>
