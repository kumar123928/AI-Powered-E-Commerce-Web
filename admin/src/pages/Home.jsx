...
fetchCounts()
  ...
  return (
    <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] relative' >
     ...
     <div className='ml-[20%] w-[80%] h-[100vh] flex items-center justify-start flex-col gap-[40px] py-[100px]'>


        <h1 className='text-[35px] text-[#afe2f2]'>OneCart Admin Panel</h1>
        <div className='flex items-center justify-center gap-[50px] flex-col md:flex-row w-full'>
