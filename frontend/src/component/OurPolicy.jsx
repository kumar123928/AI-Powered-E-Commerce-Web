  ...
  return (
    <div className='w-[100vw] h-[100vh] md:h-[70vh] flex items-center justify-start flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px]'>
          <div className='h-[8%] w-[100%] text-center mt-[70px] '>
            ...
            <p className='w-[100%] m-auto text-[13px] text-blue-100 '>Customer-Friendly Policies - committed to your Satisfaction and Safety.</p>
          </div>
...
<p className='font-semibold md:text-[18px] text-[12px] text-[aliceblue] text-center'>Shop with Confidence - 7 Days Easy Return Gaurantee.
