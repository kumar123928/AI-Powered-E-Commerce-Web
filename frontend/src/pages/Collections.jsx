...
useEffect(()=>{
  ...
  return (
    <div className='w-[98vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start flex-col md:flex-row justify-start pt-[70px] overflow-x-hidden z-[2] pb-[110px]'>
      <div className={`md:w-[30vw] lg:w-[20vw] w-[80vw] md:min-h-[100vh] p-[20px] ${showFilter ? "h-[45vh]" : "h-[8vh]"} border-r-[1px] border-gray-400 text-[#aaf5fa] lg:fixed`}>
...
filterProduct.map((item, index)=>(
  ...
  price={item.price}
  //  image={item.image[0]}
  image={item?.image?.[0] || item?.images?.[0] || "/no-image.png"}
  status={item.status}
