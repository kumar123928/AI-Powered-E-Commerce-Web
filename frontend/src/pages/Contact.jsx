...
function Contact() {
  return (
    <div className='w-[98.8vw] min-h-[100vh] flex items-center justify-center flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-[80px]'>
...
<button className='px-[30px] py-[20px] flex items-center text-[white] bg-transparent border active:bg-slate-600 rounded-md cursor-pointer'>Explore Jobs</button>
          </div>
      </div>
